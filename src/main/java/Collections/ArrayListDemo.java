...
// Refer https://howtodoinjava.com/java/collections/arraylist
...
//
        ArrayList list1 = new ArrayList<>(Arrays.asList("abcd","efhf","ijkl","mfno"));


        System.out.println(list1.removeIf(el -> ((String)el).length() == 3));
